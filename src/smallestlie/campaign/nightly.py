...
def default_nightly_batch() -> BatchConfig:
    ...
    return BatchConfig(
        ...
        items=[
            ...
            BatchItem(
                # Real engine (v0.2.12 pinned). Wave0 is fully rejected on this
            ...
            BatchItem(
                # Sensitivity control: the deliberately blind stand-in must
                # keep false-accepting, or the harness lost its teeth.
