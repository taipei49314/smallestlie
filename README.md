...
| Checkwash **real-engine** campaigns | `adapter checkwash` + wave0 / wave1 / wave2 / `checkwash-regressions` (v0.2.8 pyz) — [wave0](docs/adapters/CHECKWASH_CAMPAIGN.md) · [M1](docs/adapters/CHECKWASH_M1.md) · [M2](docs/adapters/CHECKWASH_M2.md) |
